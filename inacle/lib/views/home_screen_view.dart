  ...
  DataTable _buildDataTable(List<Map<String, dynamic>> data) {
    ...
    return DataTable(
      ...
      columns: const [
        ...
        DataColumn(label: Text('Investments (INR)', style: headerStyle)),
        DataColumn(label: Text('Dividend Reinvest', style: headerStyle)),
        DataColumn(label: Text('Dividend (INR)', style: headerStyle)),
